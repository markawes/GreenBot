...
module.exports.run = async (bot, message, args) => {
  ...
  if(!message.channel.permissionsFor(message.guild.me).has("MANAGE_ROLES_OR_PERMISSIONS") && !message.channel.permissionsFor(message.guild.me).has("MANAGE_CHANNELS")) return message.reply(`I don't have "Manage Permissions" in this channel!`)
